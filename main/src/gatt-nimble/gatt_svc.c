...
/* Gamepad service*/
static const ble_uuid128_t gamepad_svc_uuid =
    BLE_UUID128_INIT(0xab, 0xf0, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00,
                     0x00, 0x80, 0x5f, 0x9b, 0x34, 0xfb, 0x00, 0x00);
static const ble_uuid128_t gamepad_chr_uuid =
    BLE_UUID128_INIT(0xab, 0xf1, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00,
                     0x00, 0x80, 0x5f, 0x9b, 0x34, 0xfb, 0x00, 0x00);
static uint16_t gamepad_chr_val_handle;
...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    ...
    /* Gamepad service */
    {.type = BLE_GATT_SVC_TYPE_PRIMARY,
     .uuid = &gamepad_svc_uuid.u,
     .characteristics =
         (struct ble_gatt_chr_def[]){
             {/* Gamepad characteristic */
              .uuid = &gamepad_chr_uuid.u,
              .access_cb = gamepad_chr_access,
              .flags = BLE_GATT_CHR_F_WRITE,
              .val_handle = &gamepad_chr_val_handle},
             {
                 0, /* No more characteristics in this service. */
             }}},
...
static int gamepad_chr_access(uint16_t conn_handle, uint16_t attr_handle,
    ...
    /* Handle access events */
    /* Note: Gamepad characteristic is write only */
    switch (ctxt->op) {
